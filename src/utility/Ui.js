...
export function UiTitle1(props) {
    return (
        <Text style={[style.uiTitle1, props.style]}> {props.children}</Text>
    );
  }
  
  export function UiTitle2(props) {
    return (
        <Text style={[style.uiTitle2, props.style]}> {props.children}</Text>
    );
  }  
  export function UiTitle3(props) {
    return (
        <Text style={[style.uiTitle3, props.style]}> {props.children}</Text>
    );
  }
  export function Paragraph(props) {
    return (
        <Text style={[style.paragraph, props.style]}> {props.children}</Text>
    );
  }  
